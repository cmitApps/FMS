<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSFundTransfer.aspx.cs" Inherits="ASPFundManagement.CSFundFundTransfer" %>
...
<head>
	...
	<meta charset="utf-8">
	<title>Fund Management - Transfer</title>
...
<div class="clearfix"></div>
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<!-- END PAGE HEADER-->
             ...
             <form id="Form1" runat="server">
               ...
               <div id="upperMenu" style="visibility:hidden">
                <asp:Button ID ="btnNew" runat="server" Text="New" OnClientClick="return false;"/>
                <asp:Button ID ="btnModify" runat="server" Text="Modify" OnClientClick="return false"/>
                           ...
                           <%-- <asp:ListItem Value="0">&lt;Select Status&gt;</asp:ListItem>
                            ...
                            <span> <asp:DropDownList ID="cboMode" runat="server">
                           ...
                           <%-- <asp:ListItem>&lt;Select Mode&gt;</asp:ListItem>
                            ...
                            <span> <asp:TextBox ID="datePicker" runat="server">
                           <%-- <asp:ListItem>&lt;Select Mode&gt;</asp:ListItem>
                            <asp:ListItem>Bank</asp:ListItem>
                            <asp:ListItem>Mlhullier</asp:ListItem>--%>
                            </asp:TextBox></span>
                 ...
                 <br/>
                 <a id="btnAll" href="#" style="visibility:hidden">Select All</a> &nbsp;&nbsp;&nbsp;<a id="btnDeselect" href="#" style="visibility:hidden">Deselect</a>  
                                       ...
                                       <asp:TableRow ID="TableRow2" Runat="server" Font-Bold="True"
                                        ForeColor="Black" BackColor="Silver" AutoPostBack="False">
                                          ...
                                          <asp:TableHeaderCell Width="150" style="text-align:center">Area - Unit</asp:TableHeaderCell>
                                           ...
                                           <asp:TableHeaderCell Width="100" style="text-align:center">Transfer Mode</asp:TableHeaderCell>
                                           <asp:TableHeaderCell  Width="150" style="text-align:center">Bank Name / Branch</asp:TableHeaderCell> 
                                           <asp:TableHeaderCell  Width="100" style="text-align:center">Date <br/>Transferred</asp:TableHeaderCell>  
                                            <asp:TableHeaderCell  Width="100" style="text-align:center">Date <br/>Posted</asp:TableHeaderCell>  
                  ...
                  <div class="table-scrollable" id="divTransferBank" style="visibility:collapse;border:none">
                      
                                 <asp:Table ID="tblTransferBank" Runat="server" BorderStyle="Solid"  AutoPostBack="False" AllowMutiRowSelection="true" GridLines="Both" Width="1600px" >
                                       ...
                                       <asp:TableRow ID="TableRow1" Runat="server" Font-Bold="True"  ForeColor="Black" BackColor="Silver" AutoPostBack="False">
                                          ...
                                          <asp:TableHeaderCell Width="150" style="text-align:center">Area-Unit</asp:TableHeaderCell>
                                           ...
                                           <asp:TableHeaderCell Width="100" style="text-align:center">Amount</asp:TableHeaderCell>
                                           <asp:TableHeaderCell Width="75" style="text-align:center">Transfer<br/> Type</asp:TableHeaderCell>
                                           <asp:TableHeaderCell Width="100" style="text-align:center">Bank Name</asp:TableHeaderCell>
                                           <asp:TableHeaderCell Width="100" style="text-align:center">Date <br/>Transferred</asp:TableHeaderCell>
                                           <asp:TableHeaderCell  Width="100" style="text-align:center">Date <br/>Posted</asp:TableHeaderCell>
                                           <asp:TableHeaderCell  Width="200" style="text-align:center">Status</asp:TableHeaderCell>    
                                           <asp:TableHeaderCell  Width="100" style="text-align:center">OR Number</asp:TableHeaderCell>  
                                           <asp:TableHeaderCell  Width="100" style="text-align:center">Remarks</asp:TableHeaderCell>  
                 ...
                 <div class="table-scrollable" id="divTransferMlhullier" style="visibility:collapse;border:none">
                                 <asp:Table ID="tblTransferMlhullier" Runat="server" BorderStyle="Solid"  AutoPostBack="False" AllowMutiRowSelection="true" GridLines="Both" Width="1600px" >
                                  
                                       <asp:TableRow ID="TableRow3" Runat="server" Font-Bold="True"  ForeColor="Black" BackColor="Silver" AutoPostBack="False">
                                           <asp:TableHeaderCell Width="30" style="text-align:center"></asp:TableHeaderCell>
                                           <asp:TableHeaderCell Width="75" style="text-align:center">ID</asp:TableHeaderCell>
                                           <asp:TableHeaderCell Width="150" style="text-align:center"> Area-Unit </asp:TableHeaderCell>
                                           <asp:TableHeaderCell Width="100" style="text-align:center">Amount</asp:TableHeaderCell>
                                           <asp:TableHeaderCell Width="100" style="text-align:center">Transfer<br/> Type</asp:TableHeaderCell>
                                           <asp:TableHeaderCell Width="100" style="text-align:center">Transfer<br/> Mode</asp:TableHeaderCell>  
                                           <asp:TableHeaderCell Width="100" style="text-align:center">Date <br/>Transferred</asp:TableHeaderCell>
                                           <asp:TableHeaderCell  Width="100" style="text-align:center">Date <br/>Posted</asp:TableHeaderCell>
                                           <asp:TableHeaderCell  Width="200" style="text-align:center">Status</asp:TableHeaderCell>    
                                           <asp:TableHeaderCell  Width="100" style="text-align:center">OR Number</asp:TableHeaderCell>  
			...
			<div class="clearfix" id="lowerMenu" style="visibility:hidden">
               <span><asp:Button ID="btnAcknowledge" runat="server" Text="Acknowledge" OnClientClick="return false"/></span>      
               <span><asp:Button ID="btnCancelRequest" runat="server" Text="Cancel Transfer" OnClientClick="return false"/></span>
            </div>
    ...
    <script type="text/javascript" src="jquery/CSFundTransfer.js"></script>
